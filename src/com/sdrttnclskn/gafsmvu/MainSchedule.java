...
public class MainSchedule {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		population.getSchedules()
				.forEach(schedule -> System.out.println("     " + mainSchedule.scheduleNumb++ + "      | " + schedule
		...
		while (population.getSchedules().get(0).getFitness() != 1.0) {
			...
			population.getSchedules()
					.forEach(schedule -> System.out.println("     " + mainSchedule.scheduleNumb++ + "      | "
	...
	private void printScheduleAsTable(Schedule schedule, int generation) {
		...
		System.out.print("\n                     ");
		System.out.println(
				"Class # | Dept   | Course (number, max # of students ) | Room (Capacity) |       Instuctor (Id)    |   Meeting Time (Id)  ");
		System.out.print("                     ");
		System.out.println(
				"---------------------------------------------------------------------------------------------------------------------------------");
		classes.forEach(x -> {
			...
			System.out.println(data.getMeetingTimes().get(meetinTimeIndex).getTime() + "("
					+ data.getMeetingTimes().get(meetinTimeIndex).getId() + ") ");
			classNumb++;
		});
