...
public class Data {
	...
	private Data initialize() throws FileNotFoundException {
		...
		// new course
		Course course1 = new Course("C1", "325K", 25,
				new ArrayList<Instructor>(Arrays.asList(instructor1, instructor2, instructor4)));
		Course course2 = new Course("C2", "319K", 35,
				new ArrayList<Instructor>(Arrays.asList(instructor4, instructor2, instructor3)));
		Course course3 = new Course("C3", "416K", 20,
				new ArrayList<Instructor>(Arrays.asList(instructor1, instructor2)));
		Course course4 = new Course("C4", "464K", 25,
				new ArrayList<Instructor>(Arrays.asList(instructor3, instructor4)));
		Course course5 = new Course("C5", "360C", 35, new ArrayList<Instructor>(Arrays.asList(instructor4)));
		Course course6 = new Course("C6", "303K", 35,
				new ArrayList<Instructor>(Arrays.asList(instructor1, instructor3)));
		Course course7 = new Course("C7", "303LK", 20,
				new ArrayList<Instructor>(Arrays.asList(instructor2, instructor4)));
